...
const form = useForm({
    _method: 'PUT',
    numero_patrimonio: props.patrimonio.numero_patrimonio,
    nome: props.patrimonio.nome,
    descricao: props.patrimonio.descricao || '',
    user_id: props.patrimonio.user_id || '',
    data_atribuicao: props.patrimonio.data_atribuicao ? props.patrimonio.data_atribuicao.split('T')[0] : '',
});

const submit = () => {
    form.post(route('patrimonios.update', props.patrimonio.id));
};
</script>
            ...
            <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-gray-900">Editar Patrimônio</h1>
                    </div>
                </div>
