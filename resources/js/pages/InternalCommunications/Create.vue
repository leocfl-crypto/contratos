...
const submit = () => {
    form.post(route('internal-communications.store'), {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <Head title="Nova Comunicação Interna" />
        ...
        <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8 text-center">
                    <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg shadow-blue-500/30">
                        <MailPlus class="h-8 w-8 text-white" />
                    </div>
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Nova Comunicação Interna</h1>
                    <p class="mt-2 text-gray-600">Preencha os campos abaixo para criar uma nova CI</p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-xl shadow-gray-200/50 ring-1 ring-gray-100 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200/60">
                        ...
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Número e data da comunicação</p>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-5 sm:grid-cols-2">
                            <!-- Communication Code -->
                            <div>
                                <InputLabel for="code" value="Número da CI *" class="text-sm font-medium text-gray-700" />
                                <div class="relative mt-2">
                                    ...
                                    <Input
                                        ...
                                        v-model="form.code"
                                        type="text"
                                        class="block w-full rounded-xl border-gray-200 bg-gray-50 py-3 pl-10 font-mono text-sm transition-all duration-200 placeholder:text-gray-400 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20"
                                        required
                                ...
                                <p class="mt-2 flex items-center gap-1.5 text-sm text-gray-500">
                                    ...
                                    Sugestão: <span class="font-mono font-medium text-blue-600">{{ nextCode }}</span>
                                </p>
                            ...
                            <div>
                                ...
                                <div class="relative mt-2">
                                    ...
                                    <Input
                                        ...
                                        v-model="form.date"
                                        type="date"
                                        class="block w-full rounded-xl border-gray-200 bg-gray-50 py-3 pl-10 text-sm transition-all duration-200 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20"
                                        required
                                    />
                                </div>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-xl shadow-gray-200/50 ring-1 ring-gray-100 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200/60">
                        ...
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Quem está enviando a comunicação</p>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-2">
                                        ...
                                        <Input
                                            ...
                                            type="text"
                                            class="block w-full rounded-xl border-gray-200 bg-gray-50 py-3 pl-10 text-sm transition-all duration-200 placeholder:text-gray-400 focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/20"
                                            placeholder="Ex: Coordenador, Diretor, etc."
                                        />
                                    </div>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-xl shadow-gray-200/50 ring-1 ring-gray-100 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200/60">
                        ...
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Para quem a comunicação é destinada</p>
                            </div>
                        </div>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-xl shadow-gray-200/50 ring-1 ring-gray-100 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200/60">
                        ...
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Assunto e corpo da comunicação</p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:justify-between">
                        ...
                        <button
                            ...
                            class="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 transition-all duration-200 hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl hover:shadow-blue-500/40 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            <Send class="h-5 w-5" />
                            {{ form.processing ? 'Salvando...' : 'Criar Comunicação' }}
                        </button>
                    </div>
                </form>
            </div>
