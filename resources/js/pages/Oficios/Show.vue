        ...
        <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <a
                        :href="`/oficios/${oficio.id}/pdf`"
                        class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition-all duration-200 hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl hover:shadow-indigo-500/40"
                    >
                ...
                <div class="overflow-hidden rounded-2xl bg-white shadow-xl shadow-gray-200/50 ring-1 ring-gray-100">
                    <!-- Document Header -->
                    <div class="border-b border-gray-200 bg-gradient-to-r from-indigo-800 to-purple-900 px-8 py-8 text-center">
                        <div class="mb-2 text-4xl">⚜</div>
                        <h2 class="text-xl font-bold uppercase tracking-wide text-white">
                            Prefeitura Municipal de Lagoa Santa
                        </h2>
                        <p class="mt-1 text-sm text-indigo-200">Estado de Minas Gerais</p>
                    </div>

                    <!-- Document Number -->
                    <div class="border-b border-gray-100 bg-indigo-50 px-8 py-4 text-center">
                        <div class="inline-flex items-center gap-2 rounded-xl bg-indigo-100 px-6 py-2">
                            <Hash class="h-5 w-5 text-indigo-600" />
                            <span class="text-lg font-bold text-indigo-800">
                                OFÍCIO Nº {{ oficio.code }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-6 rounded-xl bg-emerald-50 p-5">
                            ...
                            <div class="space-y-2 pl-10">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-medium text-gray-900">{{ oficio.sender_name }}</span>
                                </div>
                                <div v-if="oficio.sender_role" class="flex items-center gap-2 text-sm text-gray-600">
                                    <span class="text-emerald-600">Cargo:</span>
                                    {{ oficio.sender_role }}
                                </div>
                                <div v-if="oficio.department" class="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <div class="mb-6 rounded-xl bg-purple-50 p-5">
                            ...
                            <div class="space-y-2 pl-10">
                                <div class="flex items-center gap-2">
                                    <User class="h-4 w-4 text-purple-600" />
                                    <span class="font-medium text-gray-900">{{ oficio.recipient_name }}</span>
                                </div>
                                <div v-if="oficio.recipient_role" class="flex items-center gap-2 text-sm text-gray-600">
                                    <span class="text-purple-600">Cargo:</span>
                                    {{ oficio.recipient_role }}
                                </div>
                                <div v-if="oficio.recipient_institution" class="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <div class="mb-6 rounded-xl bg-amber-50 p-5">
                            ...
                            <div class="pl-10">
                                <p class="text-lg font-semibold text-gray-900">{{ oficio.subject }}</p>
                            </div>
                        </div>
                        ...
                        <div class="my-8 flex items-center">
                            ...
                            <div class="px-4">
                                <FileStack class="h-5 w-5 text-gray-300" />
                            </div>
                            <div class="flex-1 border-t border-gray-200"></div>
                        </div>
                        ...
                        <div class="prose prose-gray max-w-none">
                            <div class="whitespace-pre-wrap text-gray-700 leading-relaxed">{{ oficio.content }}</div>
                        </div>
                        ...
                        <div class="mt-12 text-center">
                            ...
                            <div class="inline-block border-t border-gray-400 pt-3 px-8">
                                <p class="font-semibold text-gray-900">{{ oficio.sender_name }}</p>
                                <p v-if="oficio.sender_role" class="text-sm text-gray-600">{{ oficio.sender_role }}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-between">
                    ...
                    <a
                        :href="`/oficios/${oficio.id}/pdf`"
                        class="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition-all duration-200 hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl hover:shadow-indigo-500/40"
                    >
                        <FileDown class="h-5 w-5" />
                        Baixar PDF
                    </a>
